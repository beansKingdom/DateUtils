...
class DateUtils:
    ...
    """
    @classmethod
    def compute_interval_days(cls, interval_days, input_time=None):
        if not input_time:
    ...
    """
    @classmethod
    def compute_time_delta(cls, interval_time=0):
    ...
    """
    @classmethod
    def compute_time(cls, interval=0):
    ...
    """
    @classmethod
    def compute_last_week_time(cls):
        now_time = datetime.datetime.now()
        day_format = "%Y-%m-%d"
    ...
    :param input_time type: str, format: "%Y-%m-%d"
    """
    @classmethod
    def compute_interval_day(cls, input_time):
...
if __name__ == '__main__':
    a = DateUtils()
    print(a.compute_interval_days(-3))
